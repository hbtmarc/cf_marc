...
const shots = [
  {
    file: "planejamento-empty-1440.png",
  ...
  },
  {
    ...
    storage: "storage-planejamento.json",
    route: "#/planejamento",
    width: 1440,
    height: 900,
  },
  {
    file: "planejamento-occurrences-1440.png",
    storage: "storage-planejamento.json",
    route: "#/planejamento",
    width: 1440,
    height: 900,
  ...
  {
    file: "planejamento-match-1440.png",
    storage: "storage-planejamento.json",
    route: "#/planejamento",
    width: 1440,
    height: 900,
    selector: ".planejamento-occurrence",
  },
  {
  ...
  {
    file: "planejamento-occurrences-390.png",
    storage: "storage-planejamento.json",
    route: "#/planejamento",
    width: 390,
    height: 844,
